            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text flex items-center gap-2">
                    Native Language
                    {getFlagUrl(formState.nativeLanguage) && (
                      <img src={getFlagUrl(formState.nativeLanguage)} alt="flag" className="h-3 shadow-sm rounded-sm" />
                    )}
                  </span>
                </label>
                <select
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text flex items-center gap-2">
                    Learning Language
                    {getFlagUrl(formState.learningLanguage) && (
                      <img src={getFlagUrl(formState.learningLanguage)} alt="flag" className="h-3 shadow-sm rounded-sm" />
                    )}
                  </span>
                </label>
                <select
